...
Открывать конференцию будет [Yegor Bugayenko](http://yegor256.com) с докладом про ООП в юнит тестах. А это значит, градус конференции будет выским с самого начала.
