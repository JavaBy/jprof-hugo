...
Почти весна, ребята! Закрываем зиму облачным митапом и общественными дискуссиями. Юрий поведует, как смогли создать 
надёжное облачное хранилище данных для распределённых сервисов. Алексей же, пройдя несколько миграций в облака различных провайдеров
и успешно их завершив, поделится историей как спокойно подготовиться, начать и закончить миграцию в срок.
...
[Регистрируйся и заполняй профиль с помощью MixMatch](<TDB>) и приходи на митап!

<!--more-->

В сотрудничестве с минской компаний JazzPixel, пробуем их разработку, программу **MixMatch**. <TDB>
